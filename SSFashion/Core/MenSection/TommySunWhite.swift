...
struct TommySunWhite: View{
    
    @State var items = [
        
        Item(id: 0, name:"Tommy Sun White" ,material: "100% Cotton" ,pattern:"Slim Fit" ,SKU: "W01789W", condition: "Excellent" ,price: 160.00 ,image: "TommyWhite.usdz" ,detail: "Machine Wash Cold With Similar Fabrics, Do Not Tumble Dry, Do Not Use Fabric Softeners, Wash Dark Color Seperately, Wash And Iron Inside Out, Do Not Iron On Embellishment")
    ]
...
struct TommySunWhite_Previews: PreviewProvider {
